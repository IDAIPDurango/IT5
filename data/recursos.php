<?php
	...
	$consulta = "SELECT * FROM recursos WHERE tipo_recurso='SI' AND anio=$anio AND id_busqueda=$id";
	...
	$consulta = "SELECT * FROM recursos WHERE tipo_recurso='DP' AND anio=$anio AND id_busqueda=$id";
	$stmt = $db_con->prepare($consulta);
	$stmt->execute();
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<h5>Recursos de revisión por mes</h5>
			<div id="chart"></div>
		</div>
		<div class="col-md-6">
			<h5>Recursos de revisión por trimestre</h5>
	...
	<div class="row">
		<?php
			$consulta = "SELECT * FROM recursos_detalle WHERE anio=$anio AND id_busqueda=$id ORDER BY orden";
			$stmt = $db_con->prepare($consulta);
			$stmt->execute();
